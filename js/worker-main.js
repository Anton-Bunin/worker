    ...
    sorted.forEach(b => {
        ...
        if (isAdmin) {
            html += `<td style="width: 120px !important; padding: 2px 8px; text-align: right; white-space: nowrap;">
                        ${isP ? `<button class="admin-confirm-btn" data-id="${b.id}" style="font-size:14px; padding:0 4px; height: 14px; min-width: 70px; background:#2ecc71; color:#fff; border:none; border-radius:23px; cursor:pointer;">ОК</button>` : ''}
